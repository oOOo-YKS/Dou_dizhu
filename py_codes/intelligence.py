...
class HistoryRnnModel(nn.Module):
    def __init__(self):
        super().__init__()
        self.rnn = nn.GRU(input_size=18, hidden_size=512, num_layers=3, batch_first=False)
...
class StateModel(nn.Module):
    def __init__(self):
        ...
        self.hand = HandModel()
        self.fc = nn.Linear(256 + 30, 128)  # Combine history and hand
...
class PolicyHead(nn.Module):
    def __init__(self):
        super().__init__()
        self.fc1 = nn.Linear(128 + 15 + 1, 128)
        self.fc2 = nn.Linear(128, 64)
